...
This is one of the most basic ways to present the epidemic situation by using computer visualization technology.
...
No matter what kind of map, its role is to help the local people and government understand the severity of the epidemic, and help the government to take actions to treat the epidemic situation.
These two figures (Figure 4) are similar to the previous Figure 2, except that Figure 2 only shows the data of one province in China.
The contents in these maps include: confirmed cases, deaths, historical cases, added cases, and regional lockdown status.
\\
Some disadvantages of such maps are discussed in section 1: \textbf{Introduction}.
\begin{figure}[h]
    \centering
