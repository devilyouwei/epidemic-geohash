...
\begin{abstract}
	...
	Such kind of geographic information system or GeoHash technology can be used not only for preventing and controlling COVID-19 pandemic, but also for other infectious diseases.
\end{abstract}
...
\end{enumerate}
In the practical and experimental scenarios, we developed such a particular GIS for medical prevention and treatment with mobile terminal application and web technology. It can help the medical workers as a visual auxiliary tool.
\\
We will introduce some other related work in preventing epidemic by using modern information technologies. Then we focus on how we use \textbf{GeoHash} to divide dynamic blocks, and make quantitative analysis of safety level. Finally we will give our experimental and test data, and summarize the conclusion.
